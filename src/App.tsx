...
<img src={logo} alt="logo" width={150} height={150} />
            ...
            <div className="hidden md:flex items-center space-x-4">
              <button className="text-orange-100 hover:text-orange-700 font-medium">
                Sign In
              </button>
              <button className="bg-orange-600 text-orange-100 px-4 py-2 rounded-md hover:bg-blue-700 transition-colors">
                Create Account
              </button>
            </div>
          ...
          <div className="md:hidden bg-white border-t border-gray-200">
            <div className="px-4 py-2 space-y-2">
              ...
              <div className="pt-2 border-t border-gray-200">
                ...
                <button className="block w-full text-left py-2 bg-orange-600 text-orange-100 rounded-md mt-2 hover:bg-blue-700">
                  Create Account
                </button>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <button className="border-2 border-orange-600 text-gray-600 px-8 py-4 rounded-lg text-lg font-semibold hover:bg-blue-50 transition-colors">
                Learn More
              </button>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              <div className="flex items-center mb-4">
                ...
                <span className="text-lg font-bold">RealMe</span>
              </div>
